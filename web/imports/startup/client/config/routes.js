...
export const routesDef = {
  ...
  OrdersListPage: {name: 'Order List', path: '/app/orders/list', component: CustomersListPage, exact: true, layout: 'main'},
  OrdersDetailPage: {name: 'Order details', path: '/app/orders/detail/:id/:code', altPath: '/app/orders/detail/', component: CustomersDetailPage, exact: true, layout: 'main'},
